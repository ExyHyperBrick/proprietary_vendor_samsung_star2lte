...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/star2lte/proprietary/vendor/etc/nfc/BRI/sec_s3nrn82_rfreg.bin:$(TARGET_COPY_OUT_VENDOR)/etc/nfc/BRI/sec_s3nrn82_rfreg.bin \
    vendor/samsung/star2lte/proprietary/vendor/etc/nfc/sec_s3nrn82_rfreg.bin:$(TARGET_COPY_OUT_VENDOR)/etc/nfc/sec_s3nrn82_rfreg.bin \
    vendor/samsung/star2lte/proprietary/vendor/etc/seccomp_policy/mediacodec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy \
